import {
  ...
  import AgencyDialog from "./CategoryDialogNV";
  ...
  class Category extends React.Component {
    ...
    render() {
      ...
      let columns = [
        ...
        { title: t("general.stt"), field: "tableData.id", align: "left", width: "150" },  
        { title: t("general.manv"), field: "code", align: "left", width: "150" },  
        { title: t("general.tennv"), field: "name", align: "left", width: "150" },  
        { title: t("general.email"), field: "email", align: "left", width: "150" },    
        { title: t("general.phone"), field: "phone", align: "left", width: "150" },  
        { title: t("general.age"), field: "age", align: "left", width: "150" },    
      ];
